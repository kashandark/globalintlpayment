    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center px-4 sm:px-0">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-8">
          ...
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-2">Transfer Error</h2>
          ...
          <div className="space-y-3">
            <button
              onClick={onClose}
              className="w-full py-4 bg-gray-900 text-white font-bold rounded-xl hover:bg-gray-800 transition-colors shadow-lg active:scale-[0.98]"
            >
              ACKNOWLEDGE
            </button>
            <button
              onClick={onClose}
              className="w-full py-3 text-gray-500 font-semibold text-sm hover:bg-gray-50 rounded-xl transition-colors flex items-center justify-center gap-2"
            >
